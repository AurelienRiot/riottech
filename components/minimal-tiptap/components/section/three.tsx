...
const COLORS: ColorPalette[] = [
  {
    ...
    colors: [
      ...
      { cssVar: "var(--mt-accent-bold-orange)", label: "Orange foncé" },
      { cssVar: "var(--mt-accent-bold-red)", label: "Rouge foncé" },
      { cssVar: "var(--mt-accent-bold-purple)", label: "Violet foncé" },
    ],
  },
  {
    label: "Palette 2",
    ...
    colors: [
      ...
      { cssVar: "var(--mt-accent-teal)", label: "Turquoise" },
      { cssVar: "var(--mt-accent-green)", label: "Vert" },
      { cssVar: "var(--mt-accent-orange)", label: "Orange" },
      { cssVar: "var(--mt-accent-red)", label: "Rouge" },
      { cssVar: "var(--mt-accent-purple)", label: "Violet" },
    ],
  },
  {
    label: "Palette 3",
    ...
    colors: [
      ...
      { cssVar: "var(--mt-accent-yellow-subtler)", label: "Jaune clair" },
      { cssVar: "var(--mt-accent-red-subtler)", label: "Rouge clair" },
      { cssVar: "var(--mt-accent-purple-subtler)", label: "Violet clair" },
    ],
  },
];
