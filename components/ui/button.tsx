...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-all ring-offset-background  focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2  disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 ",
  {
    variants: {
      variant: {
        ...
        shine:
          "text-primary-foreground animate-shine bg-linear-to-r from-primary via-primary/50 to-primary bg-size-[400%_100%] ",
        gooeyRight:
    ...
    return (
      ...
      >
        ...
        {Icon && iconPlacement === "right" && (
          <div className="w-0 translate-x-full pl-0 opacity-0 transition-all duration-200 group-hover/button:ml-2 group-hover/button:w-5 group-hover/button:translate-x-0 group-hover/button:opacity-100 ">
            <Icon />
          </div>
        )}
      </Comp>
