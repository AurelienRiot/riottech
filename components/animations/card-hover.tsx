      ...
      <div className="m-0 flex items-center justify-center p-0">
        <div className=" relative flex justify-between">
          <div className="group relative cursor-pointer">
            <div
              className="relative z-10 flex flex-col h-[300px] w-[400px] translate-y-[100px] items-center justify-center bg-gray-600 transition-all duration-500 group-hover:translate-y-0 group-hover:bg-green-600
  "
            >
...
"
            ...
            <div className="relative box-border flex h-[300px] w-[400px] translate-y-[-200px] items-center justify-center bg-white p-5 shadow-[0_20px_50px_rgba(0,0,0,0.8)] transition duration-500 group-hover:translate-y-0  ">
              <div className="opacity-0 transition-all duration-1000 group-hover:opacity-100 ">
