...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <p className="text-center font-bold">Exemple de solutions possibles :</p>
        ...
        <ul className="list-disc space-y-4 py-2 pl-6 text-base">
          <li>
            Cette solution inclut également la gestion des abonnements et la facturation directe avec le client final
            par RIOT TECH.
          </li>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          {" Profitez d'une "}
          <strong>haute éligibilité et qualité de service</strong>, grâce à notre forfait multi-opérateurs qui assure
          une couverture supérieure à tout autre opérateur en France.
        </p>
        <p>
          <em>Expliquez-nous vos besoins</em>, nous reviendrons vers vous avec une solution adaptée et à un prix
          abordable.
        </p>
        <Button className={"mx-auto cursor-pointer text-base hover:underline"} asChild>
          <Link href={"#contact-form"}>Connaître les prix</Link>
