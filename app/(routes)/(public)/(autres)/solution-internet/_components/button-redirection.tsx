    ...
    content: (
      <>
        ...
        <ul className="list-disc space-y-4 py-2 pl-6">
          ...
          <li className="text-base">
            Une qualité d’accès garanti grâce à la connectivité multi opérateurs
            (5G, 4G, 3G).
          </li>
          <li className="text-base">
    ...
    content: (
      <>
        ...
        <p>
          ...
          notre forfait multi-opérateurs qui assure une couverture supérieure à
          tout autre opérateur en France.
        </p>
        <p>
