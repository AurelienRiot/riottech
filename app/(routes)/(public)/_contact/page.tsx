...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Contact",
    description:
      "RIOT TECH est basé dans le Morbihan (56) et intervient pour les installations et SAV sur toute la Bretagne. Et sur toute la France métropolitaine pour les Box 4G.",
  };
}
