    ...
    <>
      <div className="z-10 flex flex-col items-center pt-10  font-bold text-neutral-50">
        ...
        <p className="m-4 max-w-xl text-center text-base tracking-wide md:text-lg lg:text-xl">
          RIOT TECH commercialise et installe des solutions de surveillance vidéo et de connectivité en milieu rural et
          agricole.
        </p>
        ...
        <div className="mx-6 my-10 flex w-full flex-wrap  justify-evenly  gap-20 font-bold transition-all duration-500  ease-out min-[880px]:has-[:hover]:mb-[320px]  ">
          <CardHover
            ...
            text={`Profitez d'une connexion Internet continue, économique et disponible partout avec la connexion internet RIOT TECH. Vous assurant une connexion stable grâce à la couverture multi-opérateurs. Inclut un équipement garanti à vie ainsi qu'un service après-vente prioritaire et compétent en cas de besoin.
          `}
          />
          <CardHover
            ...
            text={`Surveillance vidéo de vos bâtiments et stabulation tous types de caméras, pour tous types d'usages.
