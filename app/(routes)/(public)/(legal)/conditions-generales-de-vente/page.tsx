...
const ConditionsVentePage = () => {
  return (
    <section className="mx-auto mb-10 flex max-w-5xl flex-col gap-4 pt-12 text-lg">
      ...
      <p>
        Les présentes conditions de vente visent à définir les relations contractuelles entre RIOT TECH et
        l&apos;acheteur et les conditions applicables à tout achat effectué par le biais du site marchand de RIOT TECH,
        que l&apos;acheteur soit professionnel ou particulier. <br />
        ...
        agréées par RIOT TECH. RIOT TECH se réserve de pouvoir modifier ses conditions de vente à tout moment. Dans ce
        cas, les conditions applicables seront celles en vigueur à la date de la commande par l&apos;acheteur.
      </p>
      ...
      <p>
        ...
        <br />
        Le compte de l&apos;acheteur sera débité lors de la validation de la commande et du montant des produits ou
        services envoyés ou téléchargés.
        <br />À la demande de l&apos;acheteur, il lui sera adressée une facture par mail faisant ressortir la TVA.
      </p>
      <h2 className="text-center text-2xl">Livraisons</h2>
      <p>
        Les livraisons sont faites à l&apos;adresse indiquée dans le bon de commande qui ne peut être que dans la zone
        géographique convenue.
        <br />
        Les risques sont à la charge de l&apos;acquéreur à compter du moment où les produits ont quitté les locaux de
        RIOT TECH. En cas de dommage pendant le transport, la protestation motivée doit être formulée auprès du
        transporteur dans un délai de trois jours à compter de la livraison.
        <br />
        Les délais de livraison ne sont donnés qu&apos;à titre indicatif ; si ceux-ci dépassent trente jours à compter
        de la commande, une demande d&apos;avoir pourra être formulée.
      </p>
      ...
      <p>
        Tous les éléments du site de RIOT TECH sont et restent la propriété intellectuelle et exclusive de RIOT TECH et
        ...
        Tout lien simple ou par hypertexte est strictement interdit sans un accord écrit exprès de RIOT TECH.
      </p>{" "}
      ...
      <p>
        ...
        automatisé. <br />
        RIOT TECH se réserve le droit de collecter des informations sur les acheteurs y compris en utilisant des
        cookies, et, s&apos;il le souhaite, de transmettre à des partenaires commerciaux les informations collectées.{" "}
        <br />
        Les acheteurs peuvent s&apos;opposer à la divulgation de leurs coordonnées en le signalant à RIOT TECH. De même,
      ...
      <p>
        RIOT TECH archivera les bons de commandes et les factures sur un support fiable et durable constituant une copie
        fidèle conformément aux dispositions de l&apos;article 1348 du Code civil. <br />
        Les registres informatisés de RIOT TECH seront considérés par les parties comme preuve des communications,
      ...
      <h2 className="text-center text-2xl">Conditions et contrats d&apos;abonnement</h2>
      <a
        href="/pdf/CGA.pdf"
        className="text-blue-600 underline-offset-2 visited:text-purple-600 hover:text-blue-800 hover:underline"
        target="_blank"
