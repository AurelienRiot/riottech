...
import { type SubscriptionColumn, columns, filterableColumns, searchableColumns, viewOptionsColumns } from "./columns";
...
export const SubscriptionClient: React.FC<SubscriptionClientProps> = ({ data }) => {
  const router = useRouter();

  return (
    <>
      <div className="flex flex-col items-center justify-between sm:flex-row">
        <Heading title={`Abonnements (${data.length})`} description="Gérez les abonnements" />
        <Button
