...
export default function ErroPage({ error, reset }: { error: Error; reset: () => void }) {
  useEffect(() => {
    ...
    <>
      <div className="grid h-screen px-4 bg-primary-foreground place-content-center">
        <div className="text-center ">
          ...
          <h1
            className={`font-black text-left  text-primary tracking-[-15px] text-9xl font-source-code-pro animate-[glitch_1s_linear_infinite] 
